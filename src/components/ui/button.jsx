...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 text-center rounded-full text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-flame-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        lg: "min-h-[3.25rem] sm:min-h-14 px-5 sm:px-8 py-3 text-sm sm:text-base",
        icon: "h-11 w-11",
      },
    },
    defaultVariants: {
