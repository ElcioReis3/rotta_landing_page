export const ListFaqs = [
  {
    ...
    a: "Você ganha 3 créditos iniciais, para pedir no app, depois compra créditos dentro do app e eles ficam disponíveis na sua conta. A cada pedido entregue, o valor correspondente é descontado automaticamente do seu saldo — sem necessidade de pagar a cada compra.",
  },
  {
    q: "Em quanto tempo a entrega chega?",
    a: "O prazo varia conforme a distância até a distribuidora escolhida, mas a maioria das entregas é concluída em até 30 minutos. Você acompanha a duração do pedido diretamente no app.",
  },
  {
    q: "Posso escolher a distribuidora que vou comprar?",
  ...
  {
    q: "Como sou avisado quando o entregador estiver chegando?",
